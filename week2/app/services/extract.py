        ...
        messages=[
            {
                ...
                "content": (
                    ...
                    "Return ONLY a JSON array of strings like this: [\"item1\", \"item2\"]. "
                    "Each string is one action item. "
                    "Do NOT return a dictionary or nested structure. "
                    "Example output: [\"Fix the bug\", \"Update docs\", \"Write tests\"]"
                ),
            },
            {
                "role": "user",
